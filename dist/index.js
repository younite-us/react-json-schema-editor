...
var HighlightOffRoundedIcon = _interopDefault(require('@material-ui/icons/HighlightOffRounded'));
...
var UPDATE_JSON_ELEMENT = 'UPDATE_JSON_ELEMENT';
var UPDATE_JSON_FLAG = 'UPDATE_JSON_FLAG';
var RESET_COMPONENT = 'RESET_COMPONENT';
var PATCH_STATUS_FLAG = 'PATCH_STATUS_FLAG';
...
function createNewElementReducer(state, action) {
  if (state === void 0) {
...
var store = redux.createStore(rootReducer, composeEnhancers(redux.applyMiddleware(thunk)));

var YouCheckbox = /*#__PURE__*/function (_Component) {
  _inheritsLoose(YouCheckbox, _Component);

  function YouCheckbox(props) {
    return _Component.call(this, props) || this;
  }

  var _proto = YouCheckbox.prototype;
...
var YouAutocomplete = /*#__PURE__*/function (_Component) {
  _inheritsLoose(YouAutocomplete, _Component);

  function YouAutocomplete(props) {
    return _Component.call(this, props) || this;
  }

  var _proto = YouAutocomplete.prototype;

  _proto.render = function render() {
    return /*#__PURE__*/React__default.createElement("div", null, this.props.multiOption === 'true' ? /*#__PURE__*/React__default.createElement(Select, {
...
var YouInput = /*#__PURE__*/function (_Component) {
  _inheritsLoose(YouInput, _Component);

  function YouInput(props) {
    var _this;

    _this = _Component.call(this, props) || this;

    _this.onBlur = function (event) {
      _this.formRef.current.reportValidity();
  ...
  _proto.onChangeInput = function onChangeInput(event) {
    this.setState({
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      React__default.createElement("form", {
        ref: this.formRef
      }, /*#__PURE__*/React__default.createElement(InputBase, {
        id: "bootstrap-input",
        classes: {
...
var YouInput$1 = styles$6.withStyles(styles)(YouInput);
...
var StyledMatPanel = core.withStyles({
  root: {
    borderRadius: 0,
    border: 0,
    padding: 0,
...
var StyledMatPanelSummary = core.withStyles({
  root: {
    borderRadius: 0,
    border: 0,
    padding: 0,
...
var StyledMatPanelDetails = core.withStyles({
  root: {
    borderRadius: 0,
    border: 0,
    padding: 0,
...
var Collapsible = /*#__PURE__*/function (_Component) {
  ...
  function Collapsible(props) {
    ...
    _this.handleTypeChange = function (type) {
      ...
      if (_this.props.inputValue !== '') {
        _this.props.handleTypeChange(_this.props.inputValue, type);
      } else {
        _this.props.handleTypeChange(_this.props.currentElementIndex, type);
      }
    };

    _this.getChild = function (index) {
      _this.props.childItems.map(function (child, i) {
        if (i === index) {
          return child;
        }
      });
    ...
    _this.gotDetails = function (details, value) {
      switch (details) {
        case 'name':
          if (value !== '' && _this.state.inputName !== value) {
            if (_this.state.inputName === '') {
              _this.setState({
                inputName: value
              });

              _this.props.onChangeInputOfElement(_this.props.currentElementIndex, value);
            } else {
              _this.props.onChangeInputOfElement(_this.state.inputName, value);
        ...
        case 'description':
          ...
          if (_this.state.inputName === '') {
            _this.props.onChangeDetails(_this.props.currentElementIndex, 'description', value);
          } else {
            _this.props.onChangeDetails(_this.state.inputName, 'description', value);
          }
        ...
        case 'required':
          ...
          if (_this.state.inputName === '') {
            _this.props.onChangeRequired(_this.props.currentElementIndex, value);
          } else {
            _this.props.onChangeRequired(_this.state.inputName, value);
          }
        ...
        case 'def':
          ...
          if (_this.state.inputName === '') {
            _this.props.onChangeDetails(_this.props.currentElementIndex, 'default', value);
          } else {
            _this.props.onChangeDetails(_this.state.inputName, 'default', value);
          }
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.patchData) {
      var key = Object.keys(nextProps.patchData)[0];
  ...
  _proto.onChangeInputOfElement = function onChangeInputOfElement(event) {
  ...
  _proto.setInputValue = function setInputValue(event) {
    this.setState({
      inputNameValue: event.target.value
    });
  };

  _proto.onDeleteElement = function onDeleteElement() {
    this.props.onDeleteElement(this.props.currentElementIndex);
  };

  _proto.showDetailsClicked = function showDetailsClicked(event) {
    this.setState({
  ...
  _proto.onCloseDetailsClicked = function onCloseDetailsClicked() {
    this.setState({
      showDetails: !this.state.showDetails,
      anchorEl: null
    });
  ...
  _proto.isRequired = function isRequired(event) {
    this.setState({
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
      ...
      className: classes.expantionPanelHeader
    }, this.state.defaultValue.label === 'Object' ? /*#__PURE__*/React__default.createElement("div", {
    ...
    }), this.props.currentElementIndex !== 0 ? /*#__PURE__*/React__default.createElement(ComponentGenerator, {
      type: "arrowDownUp",
    ...
    }, this.state.isNewElement ? /*#__PURE__*/React__default.createElement(ComponentGenerator, {
      type: "input",
    ...
    }) : /*#__PURE__*/React__default.createElement("h4", null, "Properties")), this.state.defaultValue.label === 'Object' ? /*#__PURE__*/React__default.createElement("p", {
      className: classes.countBracket
    }, "[", this.state.totalChildCount, "]") : /*#__PURE__*/React__default.createElement("p", {
      className: classes.countBracket
    }), /*#__PURE__*/React__default.createElement("div", null, this.state.isNewElement ? /*#__PURE__*/React__default.createElement("div", null, this.state.showDetails ? /*#__PURE__*/React__default.createElement(ComponentGenerator, {
      type: "CancelIcon",
      onClick: this.showDetailsClicked.bind(this)
    }) : /*#__PURE__*/React__default.createElement(ComponentGenerator, {
      type: "SettingsIcon",
      onClick: this.showDetailsClicked.bind(this)
    })) : ''), this.state.isNewElement ? /*#__PURE__*/React__default.createElement("div", {
      className: classes.requiredClass
    }, /*#__PURE__*/React__default.createElement("div", {
    ...
    }, this.state.defaultValue.label === 'Object' && this.props.expanded || this.props.currentElementIndex === 0 ? /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("ul", {
      style: {
        listStyleType: 'none'
      }
      ...
      variant: "h6"
    }, "String")), /*#__PURE__*/React__default.createElement(core.IconButton, {
    ...
    }, /*#__PURE__*/React__default.createElement(HighlightOffRoundedIcon, null))), /*#__PURE__*/React__default.createElement(ComponentGenerator, {
      type: "Model",
...
var Collapsible$1 = reactRedux.connect(mapStateToProps)(core.withStyles(styles$1)(Collapsible));

var AddMore = /*#__PURE__*/function (_Component) {
  _inheritsLoose(AddMore, _Component);

  function AddMore(props) {
    return _Component.call(this, props) || this;
  }

  var _proto = AddMore.prototype;

  _proto.render = function render() {
    return /*#__PURE__*/React__default.createElement(Add, {
...
function ArrowDownUp(props) {
  return /*#__PURE__*/React__default.createElement("div", null, props.expanded ? /*#__PURE__*/React__default.createElement(ArrowDropDown, {
...
function TypeLabel(props) {
  ...
  }, /*#__PURE__*/React__default.createElement("h5", null, props.label));
}
TypeLabel.propTypes = {
...
var JsonField = /*#__PURE__*/function (_Component) {
  _inheritsLoose(JsonField, _Component);
  ...
  var _proto = JsonField.prototype;
...
var JsonBuilder = /*#__PURE__*/function (_Component) {
  _inheritsLoose(JsonBuilder, _Component);
  ...
  function JsonBuilder(props) {
    ...
    _this.patchJson = function (jsonChildArr) {
      _this.counter = jsonChildArr.length;
    ...
    _this.addMore = function (index, count) {
      var _this$childItems$push;

      store.dispatch(updateJsonFlag(false));

      if (_this.props.patchJson && _this.props.patchJson.length > 0) {
        _this.childItems = _this.props.patchJson;
      }

      _this.counter = _this.counter + 1;
      var jsonStringElement = {
        'type': 'String'
      };
      var actualCount = count + 1;
      var uniqueKey = index + ':' + actualCount;

      _this.childItems.push((_this$childItems$push = {}, _this$childItems$push[uniqueKey] = jsonStringElement, _this$childItems$push));

      _this.setState({
        newElementCount: _this.state.newElementCount + 1,
        childDeleteKey: '-1',
        childItems: _this.childItems,
        counter: _this.counter
      });

      _this.props.componentCreated(_this.childItems, _this.state.name);
    };

    _this.expandClick = function () {
      _this.setState({
        expanded: !_this.state.expanded
      });
    };

    _this.handleTypeChange = function (elementKey, type) {
      _this.setState({
        currentElementType: type
      });

      _this.props.handleChildTypeChange(elementKey, type);
    };

    _this.onChangeInputOfElement = function (elementKey, value) {
      _this.setState({
        name: value
      });

      if (_this.state.name === '') {
        _this.props.childElementNameChanged(_this.state.indexInParentArray, value, elementKey);
      } else {
        _this.props.childElementNameChanged(_this.state.indexInParentArray, value, _this.state.name);
      }
    };
  ...
  var _proto = JsonBuilder.prototype;
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.patchData && !this.state.patchComplete && this.state.name !== 'root-node') {
      ...
      var obj = nextProps.patchData[Object.keys(nextProps.patchData)[0]];

      if (!Object.keys(obj).includes('type') || obj.type === 'Object') {
        Object.keys(obj).map(function (key) {
          var _this2$childItems$pus;

          _this2.childItems.push((_this2$childItems$pus = {}, _this2$childItems$pus[key] = obj[key], _this2$childItems$pus));
        });
  ...
  _proto.childElementNameChanged = function childElementNameChanged(childInd, childValue, oldKey) {
    if (childValue !== '' && childValue !== undefined && childInd !== '' && childInd !== undefined) {
      if (this.childItems.length === 0) {
        this.childItems = this.state.childItems;
      }

      this.childItems.map(function (child) {
        if (Object.keys(child)[0] === oldKey && oldKey !== childValue) {
          var valueToReplace = child[oldKey];
  ...
  _proto.handleChildTypeChange = function handleChildTypeChange(childElementKey, childType) {
    this.childItems.map(function (child) {
      if (Object.keys(child)[0] === childElementKey) {
        if (child[childElementKey].type === 'Object' || !Object.keys(child[childElementKey]).includes('type')) {
          ...
          var remainingItems = child[childElementKey];
          child[childElementKey] = _extends({
  ...
  _proto.componentCreated = function componentCreated(childItems, childName, oldKey, newKey, deleteFlag, childKeyToDelete, lastKey) {
    ...
    if (deleteFlag) {
      ...
      this.childItems.map(function (child) {
        ...
        if (jsonKey[0] === childName) {
          ...
          [].concat(Array(itemJsonKey.length)).map(function (e, i) {
            if (oldKey === itemJsonKey[i]) {
              var valueToReplace = child[childName][oldKey];
  ...
  _proto.onDeleteElement = function onDeleteElement(currentIndex) {
    if (this.state.name === '') {
  ...
  _proto.deleteRequestChild = function deleteRequestChild(childIndex, childName, indexInParentArray) {
    var _this3 = this;

    this.counter = this.counter - 1;
    var childItemsArr = this.childItems;
    var indexOfChild = '';
    childItemsArr.map(function (child) {
      if (Object.keys(child)[0] === childName) {
        indexOfChild = _this3.childItems.indexOf(child);
      }
    });
  ...
  _proto.onChangeRequired = function onChangeRequired(childName, isRequired) {
    this.props.onChangeRequiredChild(childName, isRequired);
  };

  _proto.onChangeRequiredChild = function onChangeRequiredChild(childElementKey, isRequired) {
    this.childItems.map(function (child) {
      if (Object.keys(child)[0] === childElementKey) {
        if (isRequired) {
  ...
  _proto.onChangeDetails = function onChangeDetails(childName, details, value) {
    var _this$setState;

    this.setState((_this$setState = {}, _this$setState[details] = value, _this$setState));
    this.props.onChangeDetailsChild(childName, details, value);
  };

  _proto.onChangeDetailsChild = function onChangeDetailsChild(childElementKey, details, value) {
    this.childItems.map(function (child) {
      if (Object.keys(child)[0] === childElementKey) {
  ...
  _proto.render = function render() {
    if (!this.state.checkDeleteKey) {
      return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(ComponentGenerator, {
        type: "collapsible",
        expanded: this.state.expanded,
        expandClick: this.expandClick,
...
var mapStateToProps$1 = function mapStateToProps(store) {
  return {
    updatedRootJson: store.createNewElementReducer.rootJsonSchema,
...
var JsonBuilder$1 = reactRedux.connect(mapStateToProps$1)(JsonBuilder);
...
var ForObject = function ForObject(props) {
  var _useState = React.useState({
    ...
    required: ''
      ...
      allValues = _useState[0],
      setValue = _useState[1];

  var inputChanged = function inputChanged(state, value) {
    var _extends2;

    setValue(_extends((_extends2 = {}, _extends2[state] = value, _extends2), allValues));
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onBlur: function onBlur(event) {
      return inputChanged('def', event.target.value);
    }
  })), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("h5", {
    className: classes.labels
  }, "Description:"), /*#__PURE__*/React__default.createElement("textarea", {
    onBlur: function onBlur(event) {
      return inputChanged('description', event.target.value);
    }
  }))), /*#__PURE__*/React__default.createElement("div", {
    className: classes.divider
  }), /*#__PURE__*/React__default.createElement("div", {
    className: classes.formBox
  }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("h4", null, "Common Validations"), /*#__PURE__*/React__default.createElement("div", {
    className: classes.requiredClass
  }, /*#__PURE__*/React__default.createElement(ComponentGenerator, {
    type: "checkbox",
    onClick: function onClick(event) {
      return inputChanged('required', event.target.checked);
    }
  }), /*#__PURE__*/React__default.createElement(ComponentGenerator, {
    type: "typeLabel",
    label: "Required ?"
  }))), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("h4", null, "Object Validations"), /*#__PURE__*/React__default.createElement("div", {
    className: classes.formFieldss
  }, /*#__PURE__*/React__default.createElement(core.TextField, {
    id: "filled-number",
    label: "Minimum",
    ...
    onChange: function onChange(event) {
      return inputChanged('minimum', event.target.value);
    }
  })), /*#__PURE__*/React__default.createElement("div", {
    className: classes.formFieldss
  }, /*#__PURE__*/React__default.createElement(core.TextField, {
    ...
    type: "number",
    onChange: function onChange(event) {
      return inputChanged('maximum', event.target.value);
    }
  })), /*#__PURE__*/React__default.createElement("div", {
    className: classes.formFieldss
  }, /*#__PURE__*/React__default.createElement(core.TextField, {
    ...
    margin: "normal",
    onChange: function onChange(event) {
      return inputChanged('enum', event.target.value);
    }
  }))))));
};

var ForObject$1 = styles$6.withStyles(styles$2)(ForObject);

var DsModel = function DsModel(props) {
  switch (props.subType) {
    case "Object":
      return /*#__PURE__*/React__default.createElement(ForObject$1, props);
...
var ComponentGenerator = /*#__PURE__*/function (_Component) {
  _inheritsLoose(ComponentGenerator, _Component);

  function ComponentGenerator(props) {
    var _this;
  ...
  var _proto = ComponentGenerator.prototype;

  _proto.render = function render() {
    switch (this.props.type) {
      case "checkbox":
        return /*#__PURE__*/React__default.createElement(YouCheckbox, this.props);

      case "dropdown":
        return /*#__PURE__*/React__default.createElement(YouAutocomplete, this.props);

      case "input":
        return /*#__PURE__*/React__default.createElement(YouInput$1, this.props);

      case "collapsible":
        return /*#__PURE__*/React__default.createElement(Collapsible$1, _extends({
          childItems: this.props.childItems
        }, this.props));

      case "addMoreIcon":
        return /*#__PURE__*/React__default.createElement(AddMore, _extends({
          style: {
            color: "#A0A0A0"
          }
        }, this.props));
      ...
      case "arrowDownUp":
        return /*#__PURE__*/React__default.createElement(ArrowDownUp, _extends({
          style: {
            color: "#A0A0A0"
          }
        }, this.props));
      ...
      case "typeLabel":
        return /*#__PURE__*/React__default.createElement(TypeLabel, this.props);

      case "jsonField":
        return /*#__PURE__*/React__default.createElement(JsonField, this.props);

      case "JsonBuilder":
        return /*#__PURE__*/React__default.createElement(JsonBuilder$1, _extends({
          patchJson: this.props.patchJson
        }, this.props));

      case "deleteIcon":
        return /*#__PURE__*/React__default.createElement(DeleteIcon, _extends({
          style: {
            color: "#A0A0A0"
          }
        }, this.props));
      ...
      case "Model":
        return /*#__PURE__*/React__default.createElement(DsModel, this.props);

      case "CancelIcon":
        return /*#__PURE__*/React__default.createElement(CancelIcon, _extends({
          style: {
            color: "#A0A0A0"
          }
        }, this.props));
      ...
      case "SettingsIcon":
        return /*#__PURE__*/React__default.createElement(SettingsIcon, _extends({
          style: {
            color: "#A0A0A0"
          }
        }, this.props));
...
function traverse(jsonObj) {
  if (jsonObj !== null && typeof jsonObj == "object") {
    Object.entries(jsonObj).forEach(function (_ref) {
      var key = _ref[0],
          value = _ref[1];
...
function addArrayChildItem(key, value) {
  var _childItems$push;

  childItems.push((_childItems$push = {}, _childItems$push[key] = value, _childItems$push));
}
...
var Designer = /*#__PURE__*/function (_Component) {
  _inheritsLoose(Designer, _Component);
  ...
  _proto.jsonUploaded = function jsonUploaded(json) {
  ...
  _proto.componentCreated = function componentCreated(childItems, childName, oldKey, newKey, deleteFlag, childKeyToDelete) {
    var str = '';
    this.childItems = childItems;
    childItems.map(function (child) {
      if (str === '') {
...
var mapStateToProps$2 = function mapStateToProps(store) {
  return {
    updatedRootJson: store.createNewElementReducer.rootJsonSchema,
    patchCompletFlag: store.createNewElementReducer.patchCompletFlag
  };
...
var Designer$1 = reactRedux.connect(mapStateToProps$2)(styles$6.withStyles(styles$3)(Designer));
...
function wp(percentProp) {
  var num = percentProp.split('%')[0];

  if (num !== '100') {
    var firstW = width * parseInt(num);
    var finalWidthPercent = firstW / 100;
...
function hp(percentProp) {
  ...
  if (num !== '100') {
    var firstH = height * parseInt(num);
    var finalHeightPercent = firstH / 100;
...
var JsonSchemaViewer = /*#__PURE__*/function (_Component) {
  _inheritsLoose(JsonSchemaViewer, _Component);
...
var JsonBuilderContainer = /*#__PURE__*/function (_Component) {
  _inheritsLoose(JsonBuilderContainer, _Component);

  function JsonBuilderContainer() {
    var _this;
  ...
  var _proto = JsonBuilderContainer.prototype;
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(Designer$1, {
...
var mapStateToProps$4 = function mapStateToProps(store) {
  return {
    updatedRootJson: store.createNewElementReducer.rootJsonSchema
  };
};

var JsonBuilderContainer$1 = reactRedux.connect(mapStateToProps$4)(styles$6.withStyles(styles$5)(JsonBuilderContainer));
...
function App(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "AppCss"
  }, /*#__PURE__*/React__default.createElement(JsonBuilderContainer$1, _extends({}, props, {
    width: size,
    height: size
  })));
}

var UiJson = /*#__PURE__*/function (_Component) {
  _inheritsLoose(UiJson, _Component);

  function UiJson() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = UiJson.prototype;
  ...
  _proto.render = function render() {
    return (
      ...
      React__default.createElement(reactRedux.Provider, {
        store: store
      }, /*#__PURE__*/React__default.createElement(App, this.props))
    );
  };
